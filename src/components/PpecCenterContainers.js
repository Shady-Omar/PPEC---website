  ...
  return (
    ...
    <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-4 m-9">
      ...
      <div key={index} className="bg-gray-200 max-h-[164px] rounded-lg shadow-xl hover:shadow-2xl transition-shadow duration-300 flex flex-col items-center justify-between mb-4">
        ...
        <Link to={{
          pathname: `/Home/PPEC-details-${document.centerName}`,
          state: {
            name: document.centerName,
            address: document.centerAdressName,
          } // your data array of objects
        }} 
        className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded transition-colors duration-300 mt-4 mb-4">View Details</Link>
      </div>
